package ru.urfu.labprog_security2db_thymeleaf.controller;
...
import ru.urfu.labprog_security2db_thymeleaf.service.UserService;
...
public class SecurityController {
    ...
    public String showRegistrationForm( Model model ) {
        ...
        return "register";  // <<<<<<<<<<<< ошибка в этом месте. мб /register? - нет
    }
